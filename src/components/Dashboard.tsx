...
export function Dashboard() {
  ...
  return (
    <div className="min-h-screen w-full min-w-0 overflow-x-clip">
      <header className="w-full bg-[#1a5c38] text-white">
        <div className="mx-auto flex w-full min-w-0 max-w-6xl flex-col gap-4 px-4 py-6 sm:flex-row sm:items-center sm:justify-between sm:px-6">
      ...
      <main className="mx-auto w-full min-w-0 max-w-6xl space-y-10 px-4 py-8 sm:px-6 sm:py-10">
        {loading && !configError && (
